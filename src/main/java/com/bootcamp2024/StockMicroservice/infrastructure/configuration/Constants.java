...
public class Constants {
    ...
    public static final String ITEM_NOT_FOUND_EXCEPTION_MESSAGE = "The item indicated does not exist";
    public static final String ITEM_ALREADY_EXISTS_EXCEPTION_MESSAGE = "The item you want to create already exists";
